...
_u.ExtensibilityStrings.I_ExceededMaxNumberOfSelectedItems_Text='Too many items selected. Please select fewer items.';
...
_u.ExtensibilityStrings.l_FailedToGetLabel_Text='Unable to get sensitivity label.';
_u.ExtensibilityStrings.l_FailedToGetLabelsCatalog_Text='Unable to get sensitivity labels catalog.';
_u.ExtensibilityStrings.l_FailedToSetLabel_Text='Unable to set sensitivity label.';
...
_u.ExtensibilityStrings.l_NativeLabelingNotEnabled_Text='Sensitivity labels are not enabled.';
...
_u.ExtensibilityStrings.l_SensitivityUnableToSetParent_Text='Unable to set Sensitivity with children.';
...
_u.ExtensibilityStrings.l_UserHasNoLabelsToSet_Text='User has no labels to set.';
